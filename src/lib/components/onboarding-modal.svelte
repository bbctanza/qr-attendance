...
{#if isOpen}
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
		<!-- Modal Container -->
		<div
			class="relative flex max-h-[95vh] w-full max-w-md flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl"
		>
			<!-- Modal Header -->
			<div class="shrink-0 border-b border-border/40 p-6 sm:p-8">
			...
			<div class="flex-1 overflow-y-auto p-6 sm:p-8">
				...
				>
					...
					<div class="space-y-2">
						...
						<Input id="email" type="email" value={userEmail} disabled class="bg-muted" />
					...
					<div class="space-y-2">
						<Label for="username"
							>Full Name / Username <span class="text-destructive">*</span></Label
						>
						<Input
							id="username"
							type="text"
